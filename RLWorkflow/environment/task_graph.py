...
from RLWorkflow.environment.xml_parser import XMLParser
from RLWorkflow.environment.dot_parser import DotParser
...
if __name__ == "__main__":
    task_graph = TaskGraph('../offloading_data/offload_random20/random.20.0.gv', is_xml=False)
