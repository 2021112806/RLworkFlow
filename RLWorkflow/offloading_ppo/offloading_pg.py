    ...
    def __init__(self, *, ob, ob_length, ent_coef, vf_coef, max_grad_norm):
        ...
        def train(learning_reate, clipingrange, obs, obs_length,
            ...
            td_map = {train_model.encoder_inputs: obs, train_model.encoder_lengths: obs_length,
                      ...
                      r: returns, lr: learning_reate, cliprange: clipingrange, oldneglogpac: neglogpacs,
                      oldvpred: values}
...
def learn(network, env, total_timesteps, eval_envs=None, seed=None, nupdates=1000, nsample_episode=30, nsteps=2048,
          ent_coef=0.01, lr=1e-4,
    ...
    make_model = lambda: S2SModel_Back(ob=ob, ob_length=ob_length, ent_coef=ent_coef, vf_coef=vf_coef,
...
if __name__ == "__main__":
    ...
    env = OffloadingEnvironment(resource_cluster=resource_cluster, batch_size=100, graph_number=100,
                                graph_file_paths=["../offloading_data/offload_random15/random.15."],
                                time_major=False,
